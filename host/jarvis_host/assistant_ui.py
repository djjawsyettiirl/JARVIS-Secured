...
<title>Assistant Jarvis · V 1.2</title>
<style>
...
<div class="top"><div><div class="brand">Assistant Jarvis</div><div class="version">V 1.2</div></div><div class="spacer"></div><button class="settings" onclick="location.href='/'" title="Settings">⚙ Settings</button></div>
...
<div class="foot">Assistant Jarvis · V 1.2</div></div>
<script>
